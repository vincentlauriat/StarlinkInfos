...
nonisolated struct SpaceX_API_Device_NeighborReportBasicServiceSet: Sendable {
  ...
  var bssidInformation: UInt32 = 0

  var regulatoryClass: UInt32 = 0

  var channelNumber: UInt32 = 0

  var phyType: UInt32 = 0

  /// NOTE: This field was marked as deprecated in the .proto file.
  var selfNeighborReportElement: String = String()
...
nonisolated extension SpaceX_API_Device_NeighborReportBasicServiceSet: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".NeighborReportBasicServiceSet"
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}bssid\0\u{1}ssid\0\u{3}iface_name\0\u{3}self_neighbor_report_element\0\u{3}bssid_information\0\u{3}regulatory_class\0\u{3}channel_number\0\u{3}phy_type\0")
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularStringField(value: &self.ifaceName) }()
      case 4: try { try decoder.decodeSingularStringField(value: &self.selfNeighborReportElement) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.bssidInformation) }()
      case 6: try { try decoder.decodeSingularUInt32Field(value: &self.regulatoryClass) }()
      case 7: try { try decoder.decodeSingularUInt32Field(value: &self.channelNumber) }()
      case 8: try { try decoder.decodeSingularUInt32Field(value: &self.phyType) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.ifaceName.isEmpty {
      try visitor.visitSingularStringField(value: self.ifaceName, fieldNumber: 3)
    }
    if !self.selfNeighborReportElement.isEmpty {
      try visitor.visitSingularStringField(value: self.selfNeighborReportElement, fieldNumber: 4)
    }
    if self.bssidInformation != 0 {
      try visitor.visitSingularUInt32Field(value: self.bssidInformation, fieldNumber: 5)
    }
    if self.regulatoryClass != 0 {
      try visitor.visitSingularUInt32Field(value: self.regulatoryClass, fieldNumber: 6)
    }
    if self.channelNumber != 0 {
      try visitor.visitSingularUInt32Field(value: self.channelNumber, fieldNumber: 7)
    }
    if self.phyType != 0 {
      try visitor.visitSingularUInt32Field(value: self.phyType, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: SpaceX_API_Device_NeighborReportBasicServiceSet, rhs: SpaceX_API_Device_NeighborReportBasicServiceSet) -> Bool {
    if lhs.bssid != rhs.bssid {return false}
    if lhs.ssid != rhs.ssid {return false}
    if lhs.ifaceName != rhs.ifaceName {return false}
    if lhs.bssidInformation != rhs.bssidInformation {return false}
    if lhs.regulatoryClass != rhs.regulatoryClass {return false}
    if lhs.channelNumber != rhs.channelNumber {return false}
    if lhs.phyType != rhs.phyType {return false}
    if lhs.selfNeighborReportElement != rhs.selfNeighborReportElement {return false}
